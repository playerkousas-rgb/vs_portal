...
section('支部帳戶 PBKDF2 密碼基礎');
{
  ...
  const reset = g.post({ action: 'authResetPassword', unit: '0082', actorUsername: 'leader@example.com', actorPassword: '1234', targetYmis: '1000000001', newPassword: '1234', sessionToken: login.sessionToken });
  ...
  const deleted = g.post({ action: 'authDeleteAccount', unit: '0082', actorUsername: 'leader@example.com', actorPassword: '1234', targetUsername: 'exco@example.com', sessionToken: login.sessionToken });
  ...
  const restored = g.post({ action: 'authRestoreAccount', unit: '0082', actorUsername: 'leader@example.com', actorPassword: '1234', targetEmail: 'exco@example.com', sessionToken: login.sessionToken });
