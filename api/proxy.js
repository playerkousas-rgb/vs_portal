...
const ALLOWED_ACTIONS = new Set([
  'ping', 'status', 'test', 'authLogin', 'authChangePassword', 'authResetPassword', 'authDeleteAccount', 'authRestoreAccount', 'authForgotPassword', 'authResetByToken', 'sync', 'claim', 'loan', 'noticeSignup',
